					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2 class="menu_title">Quản lý phụ kiện</h2>
							</div>
						</div>
					...
					<div class="section_content">
						...
						<div class="section_content_inner minheight">
                            ...
                            <ul class="table_tabs">
								...
								<li><a href="<?php echo base_url."admin/index.php?mod=accessories&act=add"; ?>" name=""><span><span>Thêm mới</span></span></a></li>
							</ul>
                            ...
                            <form action="" method="post" name="sac">
                               ...
                               <?php
							   	$stt = 0;
								if(isset($data['acs']) && $data['acs'] != NULL){
									foreach($data['acs'] as $items){
										$stt++;
										echo "<tr>";	
										echo "<td>$stt</td>";
										...
										echo "<td>";
												echo "<div class='actions_menu'><ul>";
													echo "<li><a href='".base_url."admin/index.php?mod=accessories&act=edit&pid=".$items['Id']."' class='edit'>Edit</a></li>";
													echo "<li><a href='".base_url."admin/index.php?mod=accessories&act=del&pid=".$items['Id']."' class='delete' onclick='return check()'>Del</a></li>";
												echo "</ul></div>";
											echo "</td>";
