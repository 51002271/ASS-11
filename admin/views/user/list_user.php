									...
									if($data['list'] != NULL){
										...
										foreach($data['list'] as $items){
											...
											if($stt % 2 == 0){
												...
												echo "<td>".$items['FullName']."</td>";
											
												echo "<td>".$items['Email']."</td>";
										
												echo "<td>";
													echo "<div class='actions_menu'><ul>";
														echo "<li><a href='index.php?mod=user&act=edit&uid=".$items['Id']."' class='edit'>Edit</a></li>";
														echo "<li><a href='index.php?mod=user&act=del&uid=".$items['Id']."' class='delete' onclick='return check()'>Del</a></li>";
													echo "</ul></div>";
												echo "</td>";
												echo "</tr>";
											}else{
