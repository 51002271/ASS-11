				...
				<!--[if !IE]>start table_wrapper<![endif]-->
							...
							<div class="table_wrapper" style="background:none;">
								<div class="table_wrapper_inner">
									...
									<form action="index.php?mod=user&act=edit&uid=<?php echo $data['info']['Id'];?>" method="post" name="sac" onsubmit="return checkuser()" enctype="multipart/form-data">
                            		<div class="form_items">
                                    	<div class="form_items_left">Tên tài khoản</div>
                                        <div class="form_items_right"><input type="text" name="username" size="30" value="<?php echo $data['info']['Username'] ;?>"/></div>
                                    </div>
                                    <div class="form_items">
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right">
                                        	<select name="level" id="level" <?php if($data['info']['Id'] == 1 ){ echo 'disabled="disabled"';} ?>>
                                                <option value="2" <?php if($data['info']['Level'] == 2){ echo "selected = 'selected'"; }?>>Thành viên</option>
                                                <option value="1" <?php if($data['info']['Level'] == 1){ echo "selected = 'selected'"; }?>>Administrator</option>
                                            </select> 
                                        </div>
                                    </div>
                                    <div class="form_items">
                                    	<div class="form_items_left">Họ tên</div>
                                        <div class="form_items_right"><input type="text" name="fullname" size="30" value="<?php echo $data['info']['FullName']; ?>" /></div>
                                    </div>
                                    ...
                                    <div class="form_items">
                                        ...
                                        <div class="form_items_right"><input type="text" name="email" size="30" value="<?php echo $data['info']['Email']; ?>" /></div>
                                    </div>
                                    <div class="form_items">
