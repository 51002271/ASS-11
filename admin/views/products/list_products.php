									...
									foreach($data['pro'] as $items){
										...
										echo "<td>";
												echo "<div class='actions_menu'><ul>";
													echo "<li><a href='".base_url."admin/index.php?mod=products&act=edit&pid=".$items['Id']."' class='edit'>Edit</a></li>";
													echo "<li><a href='".base_url."admin/index.php?mod=products&act=del&pid=".$items['Id']."' class='delete' onclick='return check()'>Del</a></li>";
												echo "</ul></div>";
											echo "</td>";
