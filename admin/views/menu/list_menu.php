					...
					<div class="title_wrapper">
						...
						<div class="title_wrapper_inner">
							...
							<div class="title_wrapper_content">
								<h2 class="menu_title">Danh sách danh mục</h2>
							</div>
						</div>
                            ...
                            <form action="" method="post" name="sac">
								<table cellpadding="0" cellspacing="0" width="905">
									<tbody><tr>
									  ...
									  <th width="185"><a href="#">Tiêu đề</a></th>
									  <th width="236"><a href="#">Danh mục cha</a></th>
											...
											if($stt % 2 == 0){
												...
												echo "<td>";
													echo "<div class='actions_menu'><ul>";
														echo "<li><a href='index.php?mod=menu&act=edit&mid=".$items['Id']."' class='edit'>Edit</a></li>";
														echo "<li><a href='index.php?mod=menu&act=del&mid=".$items['Id']."' class='delete' onclick='return check()'>Del</a></li>";
													echo "</ul></div>";
												echo "</td>";
												echo "</tr>";
											}else{
